...
//Wav Import and Export 201910291613
/*
Read Wav file >> OK
Write Wav File
*/
...
void ExportWavFile(std::string WavFileName)
{
	...
	//test check
	/*
	printf("ExportWavFile()\n");
	for (int i(0); i < 44; i++)
	{
		printf("%d\n", ExportWavFile1.ExportWavHeaderBuffer[i]);
	}*/
	...
	//Set Export Data
	//ExportAudioDataBufferChar ExportAudioDataSizeChar
	
	int ExportAudioDataSizeShort(10000);
